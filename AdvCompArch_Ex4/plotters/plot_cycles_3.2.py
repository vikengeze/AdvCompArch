...
def get_cycles_from_output_file(output_file):
	...
	return cycles, mechanism, communism
...
for dirname in sys.argv[1:]:
	...
	(cycles, mechanism, communism) = get_cycles_from_output_file(output_file1)
	results_tuples.append((mechanism, communism, cycles))
	
	(cycles, mechanism, communism) = get_cycles_from_output_file(output_file2)
	results_tuples.append((mechanism, communism, cycles))
	
	(cycles, mechanism, communism) = get_cycles_from_output_file(output_file3)
	results_tuples.append((mechanism, communism, cycles))
	
	(cycles, mechanism, communism) = get_cycles_from_output_file(output_file4)
	results_tuples.append((mechanism, communism, cycles))
	
	(cycles, mechanism, communism) = get_cycles_from_output_file(output_file5)
	results_tuples.append((mechanism, communism, cycles))
